...
L["Reagent"] = "Реагенты"
L["Recipe"] = "Рецепты"
L["Tradeskill"] = "Хозяйственные товары"
L["Weapon"] = "Оружие"
L["Key"] = "Ключи"
L["Elemental"] = "Стихии"
L["Glyph"] = "Символы"
L["Item Enhancement"] = false

-- Sub types
L["Junk"] = "Хлам"
L["Explosives and Devices"] = false
L["Parts"] = "Детали"
L["Companion Pets"] = false
...
L["Requires %a+ Riding"] = "Верховая езда %("
...
L["Darkmoon Game Token"] = false
L["Darkmoon Ride Ticket"] = false
L["Darkmoon Adventurer's Guide"] = false
...
L["[Rr]estores [%d,]+ mana and health"] = false
L["[Rr]estores [%d,]+ to [%d,]+ health and [%d,]+ to [%d,]+ mana"] = false
L["[Rr]estores [%d,]+ health and [%d,]+ mana"] = false
L["[Rr]estores [%d,]+ health and [%d,]+ to [%d,]+ mana"] = false
L["[Rr]estores [%d,]+ mana%."] = false
L["[Rr]estores [%d,]+ health"] = false
...
L[" [Rr]emoves .*effect"] = "Предпринимает попытку снять.*"
...
L["Use: Summons a stationary .* ride for"] = false
