...
-- Sub types
L["Junk"] = true
L["Explosives and Devices"] = true
L["Parts"] = true
L["Companion Pets"] = true
...
L["Manual Layout:"] = true
L["Manual Layout"] = true
L["Drag categories to arrange them freely. Off uses the automatic layout."] = true
L["Auto Stack:"] = true
...
L["Darkmoon Game Token"] = true
L["Darkmoon Ride Ticket"] = true
L["Darkmoon Adventurer's Guide"] = true
...
L["Restores [%d,]+ health over [%d,]+ sec"] = true
L["[Rr]estores [%d,]+ mana and health"] = true
L["[Rr]estores [%d,]+ to [%d,]+ health and [%d,]+ to [%d,]+ mana"] = true
L["[Rr]estores [%d,]+ health and [%d,]+ mana"] = true
L["[Rr]estores [%d,]+ health and [%d,]+ to [%d,]+ mana"] = true
L["[Rr]estores [%d,]+ mana%."] = true
L["[Rr]estores [%d,]+ health"] = true
L["Thistle Tea"] = true
...
L["a targeted Companion Pet's size for"] = true
...
L["Pet Leash"] = true
L["Use: Play fetch with most Companion Pets"] = true
...
L["Use: Summons a stationary .* ride for"] = true
...
L["Use: Battle pet experience gained is increased by"] = true
L["Use: Dress up your Perky Pug"] = true
L["Marked Flawless Battle%-Stone"] = true
L["Flawless Battle%-Training Stone"] = true
L["Battle Pet Bandage"] = true
L["Windfeather Plume"] = true
L["\nContract: "] = true
L["follower %a+ enhancement"] = true
L["Use: Upgrade a follower's"] = true
