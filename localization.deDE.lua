...
L["Reagent"] = "Reagenz"
L["Recipe"] = "Rezept"
L["Tradeskill"] = "Handwerksmaterial"
L["Weapon"] = "Waffe"
...
-- Sub types
L["Junk"] = "Plunder"
L["Explosives and Devices"] = "Sprengstoff und Geräte"
L["Parts"] = "Teile"
L["Companion Pets"] = "Haustiere"
...
L["BLUEPRINTS"] = "BAUPL\195\132NE"
L["PVP"] = "PVP"
L["REAGENT"] = "REAGENZ"
L["TRADE_GOODS"] = "HANDWERKSWAREN"
L["CLOTH"] = "STOFF"
L["FOLLOWERS"] = "ANH\195\132NGER"
L["MINIPET"] = "MINIPET"
...
L["MINING"] = "BERGBAU"
L["HERBALISM"] = "KR\195\132UTERKUNDE"
L["SKINNING"] = "K\195\156RSCHNEREI"
L["TAILORING"] = "SCHNEIDEREI"
L["INSCRIPTION"] = "INSCHRIFTENKUNDE"
L["FIRST_AID"] = "ERSTE_HILFE"
L["COOKING"] = "KOCHKUNST"
L["FISHING"] = "ANGELN"
L["ARCHAEOLOGY"] = "ARCH\195\132OLOGIE"
...
L["MONK"] = "M\195\150NCH"
L["DEMONHUNTER"] = "D\195\132MONENJ\195\132GER"
...
L["EQUIPPED"] = "ANGELEGT"
L["CRAFTINGREAGENT"] = "HANDWERKSMATERIAL"
...
L["Show on TBag"] = "Zeige in TBag-fufu"
L["Checking this option will allow you to track this currency type in TBag for this character.\n\nYou can also Shift-click a currency to add or remove it from being tracked in TBag."] = "Ist diese Option aktiviert wird diese W\195\164hrung in TBag-fufu f\195\188r diesen Charakter angezeigt.\n\nDu kannst auch auf eine W\195\164hrung Shift-Rechtsklicken um sie in TBag-fufu anzuzeigen oder zu entfernen."
...
L["Requires %a+ Riding"] = "Ben\195\182tigt .* Reite[rn]"
...
L["Darkmoon Game Token"] = "Spieljeton des Dunkelmond%-Jahrmarkts"
L["Darkmoon Ride Ticket"] = "Dunkelmond%-Ticket"
L["Darkmoon Adventurer's Guide"] = "Abenteuerf\195\188hrer des Dunkelmond%-Jahrmarkts"
...
L["If you spend at least %d+ seconds eating you will"] = "Wenn Ihr mindestens %d+ Sek. lang mit Essen verbringt, werdet Ihr"
...
L["Restores [%d,]+ health over [%d,]+ sec"] = "Stellt im Verlauf von %d+ Sek. insgesamt [%d,]+ Gesundheit wieder her%."
L["[Rr]estores [%d,]+ mana and health"] = "[Ss]tellt [%d.]+ Mana und Gesundheit wieder her"
L["[Rr]estores [%d,]+ to [%d,]+ health and [%d,]+ to [%d,]+ mana"] = "[Ss]tellt [%d.]+ bis [%d.]+ Gesundheit und [%d.]+ bis [%d.]+ Mana wieder her"
L["[Rr]estores [%d,]+ health and [%d,]+ mana"] = "[Ss]tellt [%d.]+ Gesundheit und [%d.]+ Mana wieder her"
L["[Rr]estores [%d,]+ health and [%d,]+ to [%d,]+ mana"] = "[Ss]tellt [%d.]+ Gesundheit und [%d.]+ bis [%d.]+ Mana wieder her"
L["[Rr]estores [%d,]+ mana%."] = "[Ss]tellt [%d.]+ Mana wieder her%."
L["[Rr]estores [%d,]+ health"] = "[Ss]tellt [%d.]+ Gesundheit wieder her%."
...
L["Puts the imbiber in .* where they can restore up to [%d,]+ mana"] = "Versetzt den Trinkenden in .* bis zu [%d.]+"
...
L[" [Rr]emoves .*effect"] = " %a+ .*effekt aufzuheben"
...
L["Use: Regenerate "] = "Benutzen: Regeneriert .*"
L["Use: While applied to target weapon"] = "bei Anwendung auf eine Waffe"
L["Use: Applies .* oil to your weapon"] = "Benutzen: Tr\195\164gt .*\195\182l auf Eure Waffe"
...
L["a targeted Companion Pet's size for"] = "die Gr\195\182\195\159e des"
...
L["Use: Play fetch with most Companion Pets"] = "Benutzen: Haustiere apportieren lassen"
...
L["Use: Summons a stationary .* ride for"] = "Benutzen: Beschw\195\182rt.*eine?n feststehende?n .*"
...
L["Removes a glyph effect"] = "Entfernt den Effekt einer Glyphe"
L["Contender's Costume"] = "Teilnehmerkost\195\188m"
L["Garrison Blueprint"] = "Garnisonsbaupl[a\195\164]n"
L["[Aa]rchaeology"] = "[Aa]rch\195\164ologi" -- sic!
L["digsite"] = "A?u?s?[Gg]rabungsst\195\164tte"
L["Use: Dig through the salvage"] = "Benutzen: Durchw\195\188hlt die geborgenen Teile"
L["item appropriate for your loot specialization"] = "der f\195\188r Eure Beutespezialisierung .* n\195\188tzlich ist"
L["Use: Battle pet experience gained is increased by"] = "Erh\195\182ht die durch Haustierk\195\164mpfe gewonnene Erfahrung"
L["Use: Dress up your Perky Pug"] = "Benutzen: Verkleidet Euren mopsigen Streuner"
L["Marked Flawless Battle%-Stone"] = "Makelloser Kampf\195\188bungsstein"
L["Flawless Battle%-Training Stone"] = "Gekennzeichneter makelloser Kampfstein"
L["Battle Pet Bandage"] = "Kampfhaustierbandage"
L["Windfeather Plume"] = "Windfeder"
L["\nContract: "] = "\nVertrag:"
L["follower %a+ enhancement"] = "%a+verbesserung f\195\188r Anh\195\164nger"
L["Use: Upgrade a follower's"] = "Benutzen: Wertet die .* eines Anh\195\164ngers"
...
L["Battle%-Training Stone"] = "Kampf\195\188bungsstein"
