...
-----------------------------------------------------------------------
  ...
  ["Abyssal Crest"] = "Abyssisches Tuch",
  ...
  ["Primal Hakkari"] = "Urzeitliche", -- this matches more then the Zul'Gurub stuff, we probaly have to live with that
  ...
  ["Use: Bind pages %d+"] = "Benutzen: Seiten %d+",
  ["Green Hills"] = "Gr\195\188nen H\195\188gel",
  ["Un'Goro Soil"] = "Un'Goro Erde",
  ["Morbent"] = "Morbent",
  ["Codex: "] = "Kodex: ",
  ["Manual: "] = "Handbuch: ",
  ["Expert "] = "Experten",
  ["Tome of "] = "Foliant der de[sr] ",
  ["Design: "] = "Vorlage: ",
  ["Formula: "] = "Formel: ",
  ["Recipe: "] = "Rezept: ",
  ["Pattern: "] = "Muster: ",
  ...
  ["Runed %a+ Rod"] = "Runenverzierte %a+ Rute",
  ...
  ["Head%s+"] = "Kopf%s+",
  ["Neck%s+"] = "Hals%s+",
  ["Shoulder%s+"] = "Schulter%s+",
  ["Back%s+"] = "R\195\188cken%s+",
  ["Chest%s+"] = "Brust%s+",
  ["Shirt%s+"] = "Hemd%s+",
  ["Tabard%s+"] = "Wappenrock%s+",
  ["Wrist%s+"] = "Handgelenke%s+",
  ["Hands%s+"] = "H\195\164nde%s+",
  ["Waist%s+"] = "Taille%s+",
  ["Legs%s+"] = "Beine%s+",
  ["Feet%s+"] = "F\195\188\195\159e%s+",
  ["Held In Off%-hand%s+"] = "In Schildhand gef\195\188hrt%s+",
  [" Bandage"] = "verband",
  ...
  ["Restores .* health and mana .* %d+ sec"] = "Restores .* health and mana .* %d+ sec", -- ditto
  ["Must remain seated while eating."] = "Ihr m\195\188sst beim Essen sitzen bleiben.",
  ["Restores %d+ health over %d+ sec"] = "Stellt im Verlauf von %d+ Sek. insgesamt %d+ Gesundheit und %d+ Mana wieder her",
  ["Thistle Tea"] = "Diesteltee",
  ["[Rr]estores %d+ energy"] = "[Ss]tellt %d+ Energie",
  ...
  ["Elemental %a+"] = "Elementar %a+",
  ["Essence of %a+"] = "Essenz des %a+",
