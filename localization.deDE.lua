...
-----------------------------------------------------------------------
  ...
  ["Hide Tokens"] = "Verstecke Abzeichen",
  ["The Bank"] = "Die Bank",
...
-----------------------------------------------------------------------
  ...
  ["Crystallized %a+"] = "%a+ Eiskristall",
  ["Eternal %a+"] = "\195\132onen%a+",
  ["Virtuoso Inking Set"] = "Kaiserliches Schreibzeug",
  ["Ink"] = "Tinte ",
  [" Parchment"] = "Pergament",
  [" Pigment"] = "[Pp]igmente",
  ["Grindgear Toy Gorilla"] = "Schleifritzelspielzeuggorilla",
  ["Trusty Copper Racer"] = "Zuverl\195\164ssiger Kupferflitzer",
  ["Toy Train Set"] = "Spielzeugzug",
