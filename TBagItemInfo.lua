...
function TBag:RefreshCreations(TBagCfg)
  if (TBagCfg[self.S_CREATED] == nil or TBagCfg[self.S_CREATED][self.S_VERSION] ~= 2) then
...
function TBag:RefreshReagents(TBagCfg)
  if (TBagCfg[self.S_REAGENT] == nil or TBagCfg[self.S_REAGENT][self.S_VERSION] ~= 2) then
