...
-- Quest items and Collectibles
  ...
  { L["ARGENT_DAWN"], L[""], L["Bone Fragments"], L["Miscellaneous"], L[""] },
  { L["ARGENT_DAWN"], L[""], L["Core of Elements"], L["Miscellaneous"], L[""] },
  { L["ARGENT_DAWN"], L[""], L["Crypt Fiend Parts"], L["Miscellaneous"], L[""] },
  { L["ARGENT_DAWN"], L[""], L["Dark Iron Scraps"], L["Miscellaneous"], L[""] },
  { L["ARGENT_DAWN"], L[""], L["Savage Frond"], L["Miscellaneous"], L[""] },
  ...
  { L["CENARION_CIRCLE"], L[""], L["Abyssal Crest"], L["Miscellaneous"], L[""] },
  { L["CENARION_CIRCLE"], L[""], L["Abyssal Signet"], L["Miscellaneous"], L[""] },
  { L["CENARION_CIRCLE"], L[""], L["Abyssal Scepter"], L["Miscellaneous"], L[""] },
  { L["DARKMOON_FAIRE"], L[""],  L["Darkmoon Faire Prize Ticket"], L[""], L[""] },
  { L["DARKMOON_FAIRE"], L[""],  L["Rabbit's Foot"], L["Miscellaneous"], L[""] },
  { L["DARKMOON_FAIRE"], L[""],  L["Soft Bushy Tail"], L["Miscellaneous"], L[""] },
  { L["DARKMOON_FAIRE"], L[""],  L["Vibrant Plume"], L["Miscellaneous"], L[""] },
  { L["DARKMOON_FAIRE"], L[""],  L["Small Furry Paw"], L["Miscellaneous"], L[""] },
  { L["DARKMOON_FAIRE"], L[""],  L["Evil Bat Eye"], L["Miscellaneous"], L[""] },
  { L["DARKMOON_FAIRE"], L[""],  L["Torn Bear Pelt"], L["Miscellaneous"], L[""] },
  ...
  { L["THORIUM_BROTHER"], L[""], L["Dark Iron Residue"], L["Miscellaneous"], L[""] },
  ...
  { L["ZUL_GURUB"], L[""], L["Primal Hakkari"], L[""], L[""] },
  ...
  { L["SPOREGGAR"], L[""], L["Glowcap"], L["Miscellaneous"], L[""]},
  { L["SPOREGGAR"], L[""], L["Fertile Spores"], L["Miscellaneous"], L[""]},
  { L["SPOREGGAR"], L[""], L["Sanguine Hibiscus"], L["Quest"], L[""]},
  { L["CONSORTIUM"], L[""], L["Obsidian Warbeards"], L["Quest"], L[""]},
  ...
  { L["SCRYER"], L[""], L["Dampscale Basilisk Eye"], L["Miscellaneous"], L[""]},
  { L["SCRYER"], L[""], L["Firewing Signet"], L["Quest"], L[""]},
  { L["SCRYER"], L[""], L["Sunfury Signet"], L["Quest"], L[""]},
  { L["SCRYER"], L[""], L["Arcane Tome"], L["Consumable"], L[""]},
  ...
  { L["ALDOR"], L[""], L["Fel Armament"], L["Consumable"], L[""]},
  ...
  { L["QUEST"], L[""], L["Use: Bind pages %d+"], L["Miscellaneous"], L[""] },
  { L["QUEST"], L[""], L["Green Hills"], L["Miscellaneous"], L[""] },
  { L["QUEST"], L[""], L["Un'Goro Soil"], L["Miscellaneous"], L[""] },
...
-- Equipment
  ...
  { string.format(L["EQUIPPED_%s"],L["13_OFFHAND"]), L["EQUIPPED"],
    L["Held In Off%-hand%s+"], L["Armor"], L[""] },
  ...
  { L["01_HEAD"], L[""], L["Head%s+"], L["Armor"], L[""] },
  { L["02_NECK"], L[""], L["Neck%s+"], L["Armor"], L[""] },
  { L["03_SHOULDER"], L[""], L["Shoulder%s+"], L["Armor"], L[""] },
  { L["04_BACK"], L[""], L["Back%s+"], L["Armor"], L[""] },
  { L["05_CHEST"], L[""], L["Chest%s+"], L["Armor"], L[""] },
  { L["06_SHIRT"], L[""], L["Shirt%s+"], L["Armor"], L[""] },
  { L["07_TABARD"], L[""], L["Tabard%s+"], L["Armor"], L[""] },
  { L["08_WRIST"], L[""], L["Wrist%s+"], L["Armor"], L[""] },
  { L["09_HANDS"], L[""], L["Hands%s+"], L["Armor"], L[""] },
  { L["10_WAIST"], L[""], L["Waist%s+"], L["Armor"], L[""] },
  { L["11_LEGS"], L[""], L["Legs%s+"], L["Armor"], L[""] },
  { L["12_FEET"], L[""], L["Feet%s+"], L["Armor"], L[""] },
  { L["13_OFFHAND"], L[""], L["Held In Off%-hand%s+"], L["Armor"], L[""] },
...
-- Trades (fishing done above before equipment)
  ...
  { L["ENCHANTING"], L[""], L["Small %a+ Shard"], L[""], L[""] },
  { L["ENCHANTING"], L[""], L["Large %a+ Shard"], L[""], L[""] },
