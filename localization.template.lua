...
-----------------------------------------------------------------------
  ...
  ["Hide Hilight Button"] = "Hide Hilight Button",
...
-----------------------------------------------------------------------
  ...
  ["Netherwing Crystals"] = "Netherwing Crystals",
  ...
  ["Obsidian Warbeards"] = "Obsidian Warbeards",
  ...
  ["Use: Bind pages %d+"] = "Use: Bind pages %d+",
  ...
  ["Legs%s+"] = "Legs%s+",
  ["Feet%s+"] = "Feet%s+",
  ["Held In Off%-hand%s+"] = "Held In Off%-hand%s+",
  [" Bandage"] = " Bandage",
  ...
  ["Mistletoe"] = "Mistletoe",
  ["Flame Cap"] = "Flame Cap",
  ["Allows the Imbiber to "] = "Allows the Imbiber to ",
  [" Key"] = " Key",
